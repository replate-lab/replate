...
This file is the primary experimental output. Raw logs from every run, including failed ones, are committed to [`../data`](../data).
...
- Motor current sensing is specified in the design but not yet implemented, it is required for the Phase 3 torque measurement
